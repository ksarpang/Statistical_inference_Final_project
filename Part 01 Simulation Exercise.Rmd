---
title: "Statistical Inference Project Part 1 - Investigate the exponential distribution in R & compares it with CLT - A Simulation Exercise"
...
Overview:  
---------  
This project investigates the Exponential distribution in R and compares it with the CLT. The mean of the Exponential distribution is $\frac{1}{\lambda}$ and the standard deviation is also $\frac{1}{\lambda}$. A thousand simulations of the distribution of 40 exponentials would be investigated.  
